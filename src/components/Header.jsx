  ...
  return (
    <>
      <div
        className={
          isScrolled
            ? "header__nav__container header__nav__container__active"
      ...
      >
          ...
          {isScrolled === true ? (
            ...
            >
              ...
              <path
                ...
                fill="url(#paint0_linear_355_284)"
              />
              <path
                ...
                fill="url(#paint1_linear_355_284)"
              />
              <path
                ...
                fill="url(#paint2_linear_355_284)"
              />
              <path
                ...
                fill="url(#paint3_linear_355_284)"
              />
              <path
                ...
                fill="url(#paint4_linear_355_284)"
              />
              <path
                ...
                fill="url(#paint5_linear_355_284)"
              />
              <path
                ...
                fill="url(#paint6_linear_355_284)"
              />
              <path
                ...
                fill="url(#paint7_linear_355_284)"
              />
              <mask
                id="mask0_355_284"
              ...
              <g mask="url(#mask0_355_284)">
                <path
                  ...
                  fill="url(#paint8_linear_355_284)"
                />
                <mask
                  id="mask1_355_284"
                  style={{ maskType: "luminance" }}
        ...
        {isOpen ? (
          <div className="header__nav__link__wraper">
            ...
            <Link href="/login" className="header__nav__logs__login2">
              <button className="header__nav__logs__login__btn">LOGIN</button>
            </Link>
          </div>
        ) : null}
        <div className="header__nav__logs__wraper">
          <Link href="/cart" className="header__nav__logs__cart">
            <svg
              className={`header__nav__logs__cart__svg ${
                isScrolled === true
                  ? "header__nav__logs__cart__svg__white"
                  : "header__nav__logs__cart__svg"
              }`}
              width="35"
              height="35"
              viewBox="0 0 42 43"
          ...
          <Link href="/login" className="header__nav__logs__login">
            <button
              className={`header__nav__logs__login__btn ${
                isScrolled === true
                  ? "header__nav__logs__login__btn__white"
                  : "header__nav__logs__login__btn"
              }`}
            >
              LOGIN
            </button>
