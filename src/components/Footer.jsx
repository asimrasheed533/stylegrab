...
export default function Footer() {
  const [sendOpen, setISendOpen] = React.useState(false);
  return (
    <>
      <div className="contact__container">
        <div className="contact__container__gif"></div>
        ...
        {!sendOpen ? (
          <div className="contact__container__btn">
            <button
              ...
              className="contact__container__btn__svg"
            >
              <svg
                width="24"
                height="24"
        ...
        {sendOpen === true ? (
          <div className="contant__input">
            <input
              className="contant__input__entry"
              type="mail"
              placeholder="name@gmail.com"
            />
            <div className="contant__input_button">send</div>
          </div>
        ) : null}
      </div>
      ...
      <div className="footer__explore__container__row__bottom">
        <div className="footer__explore__container__col__first">
          ...
          <div className="footer__explore__container__col__text">
            ...
            in SaaS, Media, Marketing Tech, and AI development. Whether you're a
            startup, an agency, or a big company, we've got you covered.
          </div>
        </div>
        <div className="footer__explore__container__col__wraper">
          ...
          <div className="footer__explore__container__col">
            ...
            <div className="footer__explore__container__col__entry">Terms</div>
            <div className="footer__explore__container__col__entry">
              Privacy
            </div>
            <div className="footer__explore__container__col__entry">
